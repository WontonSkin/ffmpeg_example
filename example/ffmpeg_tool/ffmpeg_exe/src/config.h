...
#define FFMPEG_CONFIGURATION "--prefix=./build --toolchain=msvc --arch=x86_64 --enable-shared --disable-static --enable-avresample --enable-libx264 --enable-gpl --enable-librtmp --enable-nonfree --extra-cflags=-I/usr/local/include/"
...
#define CC_IDENT "用于 x64 的 Microsoft (R) C/C++ 优化编译器 19.16.27043 版"
